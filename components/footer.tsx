    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-400 mb-4 max-w-md">
              Sua loja completa de tecnologia e gaming. Oferecemos os melhores produtos em hardware, periféricos e
              equipamentos gamer para elevar sua experiência digital.
            </p>
          </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400">© 2024 TechStore. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  )
